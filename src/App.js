...
const DashboardPage = () => {
  ...
  return (
    <Box sx={{ display: "flex", flexDirection: "column", height: "100vh", bgcolor: "#EAF0F6",  }}>
      ...
      <Box sx={{
        ...
        <Typography variant="h6" sx={{ fontWeight: "bold", color: "#2c3e50", ml: 3 }}>
          EcoAqua Monitor
        </Typography>
        <Box sx={{ display: "flex", alignItems: "center", gap: 1, mr: 3 }}>
          <Typography variant="body1" sx={{ fontWeight: "bold", color: "#2c3e50" }}>Hello Arthur</Typography>
      ...
      <Box sx={{ mt: "100px", display: "flex", flex: 1, p: 3, gap: "20px" }}>
        {/* coluna a esquerda */}
        <Box sx={{ width: 400, bgcolor: "#EAF0F6", p: 2, display: "flex", flexDirection: "column", alignItems: "flex-start", borderRadius: "10px", gap: "10px" }}>
          {[
          ...
          {/* 4 cards  */}
          <Box sx={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: "50px" }}>
            {[
              ...
              <Card key={index} sx={{
                ...
                <Typography variant="h4" sx={{ fontWeight: "bold", color: "#2c3e50" }}>{item.value}</Typography>
                <Typography variant="body2" color="text.secondary">{item.time}</Typography>
                <Box sx={{ display: "flex", justifyContent: "flex-end" }}>
                  <IconButton><ArrowForwardIos sx={{ fontSize: 18, color: "#bbb" }} /></IconButton>
                </Box>
              </Card>
            ))}
          </Box>
        ...
        <Box sx={{
          ...
          {[
            ...
            {
              title: "Wi-Fi",
              content: [{ text: "Rede: Eduroam UFC" }, { text: "Status: conectado" }],
              icon: <Wifi />,
            },
            {
              title: "Lora",
            ...
            <Card key={index} sx={{
              ...
              <CardContent>
                ...
                {item.content.map((textItem, idx) => (
                  <Typography key={idx} variant="body2" sx={{ display: "flex", alignItems: "center", gap: "8px", mt: 1 }}>
                    <Box sx={{
                      width: 8,
                      height: 8,
                    ...
                    <Box>
                      <Typography sx={{ fontWeight: "bold", fontSize: "14px", color: "#2c3e50" }}>{textItem.text}</Typography>
                      {textItem.time && (
                        <Typography sx={{ fontSize: "12px", color: "#718096" }}>{textItem.time}</Typography>
                      )}
                    </Box>
                  </Typography>
                ))}
